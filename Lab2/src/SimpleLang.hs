...
desugar (If expr true_state false_state) = DIf expr (desugar true_state) (desugar false_state)
...
desugar (For forInit forCond forUpd statement) = DSequence (desugar forInit) ( DWhile forCond ( DSequence (desugar statement) (desugar forUpd) ) )
